...
namespace HLess.Data.Migrations
{
    ...
    [Migration("20191016155249_ManyToManyUserAccount")]
    partial class ManyToManyUserAccount
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HLess.Models.Entities.ContentField", b =>
                {
                    ...
                    b.ToTable("ContentField");
                });

            modelBuilder.Entity("HLess.Models.Entities.ContentType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("HLess.Models.Entities.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
